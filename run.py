...
tree.column('#0', width=90, stretch=NO, anchor=CENTER)
tree.column('#1', width=90, stretch=NO, anchor=CENTER)
tree.column('#2', width=90, stretch=NO, anchor=CENTER)
tree.column('#3', width=90, stretch=NO, anchor=CENTER)
tree.column('#4', width=90, stretch=NO, anchor=CENTER)
tree.column('#5', width=90, stretch=NO, anchor=CENTER)
